...
// Object Type. 자바스크립트 타입은 Primitive type, Object type 두가지 있다.
...
tempBooks =sortObject(books);
tempBooks.forEach(element=>{
  element.title = tempBooks.indexOf(element) + ' ' + element.title;
});
